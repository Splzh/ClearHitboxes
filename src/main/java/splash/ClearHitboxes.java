...
public class ClearHitboxes implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        KeyBinding clearHitboxesMenu = KeyBindingHelper.registerKeyBinding(new KeyBinding("ClearHitboxes Menu", InputUtil.Type.KEYSYM, InputUtil.GLFW_KEY_RIGHT_CONTROL, "Clear Hitboxes"));
        KeyBinding toggleClearHitboxes = KeyBindingHelper.registerKeyBinding(new KeyBinding("Toggle ClearHitboxes", InputUtil.Type.KEYSYM, InputUtil.UNKNOWN_KEY.getCode(), "Clear Hitboxes"));
