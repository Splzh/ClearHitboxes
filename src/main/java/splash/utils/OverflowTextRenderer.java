...
public class OverflowTextRenderer {
    ...
    public void render(DrawContext context, TextRenderer textRenderer, Text text, float tickDelta, int color) {
        ...
        if (scrollRoom > 0) { // We want to start scrolling a bit before the true max width.
            ...
            context.drawTextWithShadow(textRenderer, text, (int) (startX - scrollOffset + xOffset), (int) y, color);
