...
public class Render {
    ...
    public static void drawString(MatrixStack matrices, final float scale, final String text, final float xPos, final float yPos, final int color) {
        matrices.push();
        matrices.scale(scale, scale, scale);
        MinecraftClient.getInstance().textRenderer.draw(matrices, text, xPos/scale, yPos/scale, color);
        matrices.pop();
    }
    public static void drawShadowString(MatrixStack matrices, final float scale, final String text, final float xPos, final float yPos, final int color) {
        matrices.push();
        matrices.scale(scale, scale, scale);
        MinecraftClient.getInstance().textRenderer.drawWithShadow(matrices, text, (int) (xPos/scale), (int) (yPos/scale), color);
        matrices.pop();
    }
